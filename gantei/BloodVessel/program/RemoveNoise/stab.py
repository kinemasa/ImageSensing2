...
import cv2
INPUT_DIR ="/Users/masayakinefuchi/labo/imagesensing2/ImageSensing2/gantei/BloodVessel/result/triming/"
filename_li = [INPUT_DIR+"0.png",INPUT_DIR+"5.png",INPUT_DIR+"10.png"]
img_li = []
