...
if __name__ == "__main__":
  ...
  OUTPUT_MASK1= '/Users/masayakinefuchi/labo/imagesensing2/ImageSensing2/studyFlow/result/mask1/'
  OUTPUT_MASK2= '/Users/masayakinefuchi/labo/imagesensing2/ImageSensing2/studyFlow/result/mask2/'
  OUTPUT_MASK3= '/Users/masayakinefuchi/labo/imagesensing2/ImageSensing2/studyFlow/result/mask3/'
  ...
  templatefiles = glob.glob(OUTPUT_TEMPLATE+'*')
  ...
  for template in templatefiles:
    ...
    image_mask =mask(img_clahe,img_open)
    
    mask_file = OUTPUT_MASK1 + str(i) +".jpg"
    mask_file2 = OUTPUT_MASK2 + str(i) +".jpg"
    mask_file3 =OUTPUT_MASK3+ str(i) +".jpg"
    masked_file = OUTPUT_MASKED + str(i) +".jpg"
    
    cv2.imwrite(mask_file,img_binary)
    cv2.imwrite(mask_file2,img_open)
    cv2.imwrite(mask_file3,img_binary_median)
    cv2.imwrite(masked_file,image_mask)
    i += 1
    sys.stdout.flush()
    sys.stdout.write('\rProcessing... (%d/%d)' %(i,num))
